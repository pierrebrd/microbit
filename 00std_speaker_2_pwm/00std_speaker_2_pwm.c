...
#define NOTE_RE_4    6810    // 587.33 Hz
#define NOTE_RE_4_SHARP 6428 // 622.25 Hz
#define NOTE_MI_4    6067    // 659.25 Hz
#define NOTE_FA_4    5733    // 698.46 Hz
#define NOTE_SOL_4   5102    // 783.99 Hz
#define NOTE_LA_4    4545    // 880.00 Hz
#define NOTE_SI_4    4049    // 987.77 Hz
#define NOTE_DO_5    3822    // 1046.50 Hz
...
uint16_t song[] = {
    NOTE_MI_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_SOL_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_RE_4_SHARP, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_MI_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_SI_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_RE_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_LA_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,

    NOTE_DO_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_SI_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_LA_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    ...
    NOTE_SOL_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_SI_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_DO_4, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
    NOTE_LA_3, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE, NOTE_NONE,
